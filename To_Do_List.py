...
def load_tasks(filename="to_do.txt"): #This function loads all the previous tasks in a file.
    tasks = []
...
def save_tasks(tasks, filename="to_do.txt"): #This function saves the tasks into a file and uses exception handling.
...
def clear_tasks(tasks, filename="to_do.txt"): # This function clears all the tasks from the list and the file.
